...
fun BudgetDetailedScreen(subCategoryUid: String, navigationActions: NavigationActions) {
    ...
    val subCategory = AccountingSubCategory(subCategoryUid, "Logistics Pole", AccountingCategory("Pole"), 1205)
    //TODO: fetch from db
    val budgetItems = listOf(
        BudgetItem("1", "pair of scissors", 5, TVA.TVA_8, "scissors for paper cutting", subCategory),
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { navigationActions.back()}, modifier = Modifier.testTag("backButton")) {
